			...
			<div class="collapse navbar-collapse" id="mainNavBar">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${pageContext.request.contextPath}/signup"><spring:message
								code="signup" /></a></li>
					<li class="active"><a href=""><spring:message code="login" /></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<c:url value='/login'/>" role="form" method="POST"
						...
						<div class="form-group">
							<input type="text"
								placeholder="<spring:message code="Username"/>" name="userName"
								required="required" maxlength="20">
						</div>
						<div class="form-group">
							<input type="password"
								placeholder="<spring:message code="Password"/>" name="password"
								required="required" maxlength="20">
						</div>
					</form>
				</div>
				<div class="modal-footer ">
					<button class="btn btn-primary btn-block" type="submit"
						name="submit" onclick='document.loginForm.submit();'>
						<spring:message code="login" />
					</button>
				</div>
			</div>
