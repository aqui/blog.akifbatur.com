				...
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">Post Edit Facility</h3>
						</div>
						<div class="panel-body">
							...
							<form:form action="${pageContext.request.contextPath}/post/edit/${id}" role="form" method="POST" name="postForm" modelAttribute="post">
